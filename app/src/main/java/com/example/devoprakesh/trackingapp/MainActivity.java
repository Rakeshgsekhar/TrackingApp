        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(email)||TextUtils.isEmpty(pass)||TextUtils.isEmpty(conpass)){
                    ...
                    Toast.makeText(MainActivity.this," Input fields cannot be empty",Toast.LENGTH_LONG).show();
                    ...
                    if(pass.equals(conpass)){
                                ...
                                .addOnCompleteListener(MainActivity.this, new OnCompleteListener<AuthResult>() {
                                    ...
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        ...
                                        if(task.isSuccessful()){
                                            ...
                                            editor.apply();
                                            Intent intent = new Intent(MainActivity.this,DetailsEntry.class);
                        ...
                        Toast.makeText(MainActivity.this," Password field does'nt match !!",Toast.LENGTH_LONG).show();
